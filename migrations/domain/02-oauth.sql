...
VALUES
('client_web', '3v3rm0s', 'https://evermos.com/', 'client_credentials password refresh_token', 'user');

INSERT INTO `oauth_access_token`
(`access_token`, `client_id`, `user_id`, `expires`, `scope`)
VALUES
('00000c708db9bdf1a70d5988a8f321a82970ceb5', 'client_web', NULL, '2021-08-24 20:57:59', 'user');