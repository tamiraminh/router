...
var domainBooking = wire.NewSet(
	// FooService interface and implementation
	booking.ProvideBookingServiceImpl,
	wire.Bind(new(booking.BookingService), new(*booking.BookingServiceImpl)),
	// FooRepository interface and implementation
	booking.ProvideBookingRepositoryMySQL,
	wire.Bind(new(booking.BookingRepository), new(*booking.BookingRepositoryMySQL)),
)
...
var routing = wire.NewSet(
	wire.Struct(new(router.DomainHandlers), "FooBarBazHandler", "BookingHandler"),
	handlers.ProvideFooBarBazHandler,
	handlers.ProvideBookingHandler,
